...
import org.easyarch.easynotify.kits.PropertyKits;
...
//
//        String werwe = RedisKits.getInstance().strings().set("werwe", JSON.toJSONString(map));
//        System.out.println(werwe);
//        String s = RedisKits.getInstance().strings().get("werwe");
