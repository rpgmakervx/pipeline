package org.easyarch.pipeline.common.kits.file;/**
 * Description : 
...
import org.easyarch.pipeline.common.kits.HashKits;
...
public class IOKits {
    ...
    public static boolean equals(Reader reader1, Reader reader2) {
        String hashStr1 = HashKits.sha1(getBytes(toCharArray(reader1)));
        String hashStr2 = HashKits.sha1(getBytes(toCharArray(reader2)));
        return hashStr1.equals(hashStr2);
    }
